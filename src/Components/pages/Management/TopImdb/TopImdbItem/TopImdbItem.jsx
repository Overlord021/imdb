...
import { MyContext } from "../TopImdb";
const TopImdbItem = () => {
  const { topten } = useContext(MyContext);
  return (
    <>
      <div className="w-full flex justify-center mt-2 mb-0 lg:mt-16 lg:mb-8">
        <div className="w-full lg:w-[1024px] xl:w-[1280px] bg-[#121212] lg:bg-transparent flex flex-col">
          <div className="w-full flex items-center justify-between pb-6">
            <div>
              <span className="w-[4px] h-[30px] rounded-full m-[2px] me-2 bg-[#f5c518]"></span>
              <h3 className="text-[24px] flex font-bold text-white">
                  ...
                  <div className="w-full flex flex-col bg-[#1A1A1A]">
                    ...
                    <div className="w-full flex flex-col text-start mt-1.5">
                      ...
                      <div className="w-full h-[48px] flex">
                        <span className="ms-2 text-[16px] text-white cursor-pointer hover:underline hover:underline-offset-2">
                          {elem.id}.{" " + elem.title}
                        </span>
                      </div>
